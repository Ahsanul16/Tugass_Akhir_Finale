 ...
 * Dashboard untuk superadmin dengan fitur lebih lengkap
 */
...
$user_stats = getUserStatsByRole($conn);
$online_count = 0;
$offline_count = 0;

// Count status dari database (much faster - no SNMP calls)
// Real-time check hanya dilakukan saat halaman detail/edit
...
<div class="row mb-4">
    <div class="col-md-6">
        ...
        <p class="text-muted">Pantau dan kelola seluruh sistem monitoring</p>
    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h5 class="card-title fw-bold">
                            <i class="bi bi-shield-star"></i> Profil SuperAdmin
                        </h5>
                        <p class="mb-1">
