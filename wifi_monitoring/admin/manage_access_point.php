    ...
    if (!verifyCSRFToken($csrf_token)) {
        ...
        if ($form_action === 'add') {
            ...
            if ($result['status'] === 'success') {
                header('Location: ' . $base_url . '/admin/manage_access_point.php?success=add');
                exit();
            } else {
            ...
            if ($result['status'] === 'success') {
                header('Location: ' . $base_url . '/admin/manage_access_point.php?success=edit');
                exit();
            } else {
                $error = $result['message'];
            }
...
if ($action === 'delete') {
    ...
    if ($id_ap > 0) {
        ...
        header('Location: ' . $base_url . '/admin/manage_access_point.php?success=delete');
        exit();
    }
}
...
if ($action === 'edit') {
    ...
    if ($id_ap > 0) {
        ...
        if (!$ap_data) {
            header('Location: ' . $base_url . '/admin/manage_access_point.php');
            exit();
        }
    }
}
                    ...
                    <form method="POST" action="">
                        ...
                        <?php if (empty($gedung_list)): ?>
                            <div class="alert alert-warning mt-3">
                                ...
                                Buat dulu di menu <a href="<?php echo $base_url; ?>/admin/manage_gedung.php">Kelola Gedung</a>
                                dan <a href="<?php echo $base_url; ?>/admin/manage_lantai.php">Kelola Lantai</a>.
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="d-flex gap-2 mt-4">
                            ...
                            <a href="<?php echo $base_url; ?>/admin/manage_access_point.php" class="btn btn-secondary">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo $base_url; ?>/admin/manage_access_point.php?action=add" class="btn btn-success">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="<?php echo $base_url; ?>/admin/manage_access_point.php?action=edit&id=<?php echo $ap['id_ap']; ?>" 
                                                   class="btn btn-warning" title="Edit">
                                                    <i class="bi bi-pencil"></i> Edit
                                                </a>
                                                <a href="<?php echo $base_url; ?>/admin/manage_access_point.php?action=delete&id=<?php echo $ap['id_ap']; ?>" 
