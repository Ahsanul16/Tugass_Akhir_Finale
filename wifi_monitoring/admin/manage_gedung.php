    ...
    if (!verifyCSRFToken($csrf_token)) {
        ...
        if ($form_action === 'add') {
            ...
            if ($res['status'] === 'success') {
                header('Location: ' . $base_url . '/admin/manage_gedung.php?success=add');
                exit();
            }
            $error = $res['message'];
            ...
            if ($res['status'] === 'success') {
                header('Location: ' . $base_url . '/admin/manage_gedung.php?success=edit');
                exit();
            }
            $error = $res['message'];
        }
...
if ($action === 'delete') {
    ...
    if ($id > 0) {
        ...
        header('Location: ' . $base_url . '/admin/manage_gedung.php?success=delete');
        exit();
    }
}
...
if ($action === 'edit') {
    ...
    if ($id > 0) {
        ...
        if (!$gedung_data) {
            header('Location: ' . $base_url . '/admin/manage_gedung.php');
            exit();
        }
    }
}
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo $base_url; ?>/admin/manage_gedung.php" class="btn btn-secondary">
...
<?php else: ?>
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-success" href="<?php echo $base_url; ?>/admin/manage_gedung.php?action=add">
                            ...
                            <?php $no = 1; foreach ($gedung_list as $g): ?>
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        <a class="btn btn-sm btn-warning" href="<?php echo $base_url; ?>/admin/manage_gedung.php?action=edit&id=<?php echo (int) $g['id_gedung']; ?>">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="<?php echo $base_url; ?>/admin/manage_gedung.php?action=delete&id=<?php echo (int) $g['id_gedung']; ?>"
