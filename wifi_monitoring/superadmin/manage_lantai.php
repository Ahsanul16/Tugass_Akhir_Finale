    ...
    if (!verifyCSRFToken($csrf_token)) {
        ...
        if ($form_action === 'add') {
            ...
            if ($res['status'] === 'success') {
                header('Location: ' . $base_url . '/superadmin/manage_lantai.php?success=add');
                exit();
            }
            $error = $res['message'];
            ...
            if ($res['status'] === 'success') {
                header('Location: ' . $base_url . '/superadmin/manage_lantai.php?success=edit');
                exit();
            }
            $error = $res['message'];
        }
...
if ($action === 'delete') {
    ...
    if ($id > 0) {
        ...
        header('Location: ' . $base_url . '/superadmin/manage_lantai.php?success=delete');
        exit();
    }
}
...
if ($action === 'edit') {
    ...
    if ($id > 0) {
        ...
        if (!$lantai_data) {
            header('Location: ' . $base_url . '/superadmin/manage_lantai.php');
            exit();
        }
    }
}
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo $base_url; ?>/superadmin/manage_lantai.php" class="btn btn-secondary">
...
<?php else: ?>
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-success" href="<?php echo $base_url; ?>/superadmin/manage_lantai.php?action=add">
                            ...
                            <?php $no = 1; foreach ($lantai_list as $l): ?>
                                <tr>
                                    ...
                                    <td class="d-flex gap-2">
                                        <a class="btn btn-sm btn-warning" href="<?php echo $base_url; ?>/superadmin/manage_lantai.php?action=edit&id=<?php echo (int) $l['id_lantai']; ?>">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>
                                        <a class="btn btn-sm btn-danger" href="<?php echo $base_url; ?>/superadmin/manage_lantai.php?action=delete&id=<?php echo (int) $l['id_lantai']; ?>"
